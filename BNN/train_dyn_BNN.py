...
#ENV
parser.add_argument('--env_name', type=str, default='HalfCheetah-v2')  #  Ant2-v2  HalfCheetah-v2  ArmReacherEnv-v0  Hopper2-v2: Swimmer2-v2 CartpoleSwingUp-v0
...
parser.add_argument('--drop_p', type=float, default=0.10)
parser.add_argument('--dyn_reg2', type=float, default= 0 )
parser.add_argument('--pre_process', type=ast.literal_eval, default= False)
...
dynamics = BNN3_h(env, hidden_size=[hidden_size]*num_hidden_layers, drop_prob=drop_p, activation= net_activation) .cuda()
